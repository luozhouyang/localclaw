 ...
 * Contains header with language switcher and tab navigation
 */
    ...
    <div className="min-h-screen bg-[#0D0D0D]">
      ...
      <div className="glass-strong sticky top-0 z-50 border-b border-orange-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            {/* Language switcher and status indicator */}
            <div className="flex items-center gap-3">
              <LanguageSwitcher />
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-full glass border-glow">
                <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse" />
                <span className="text-xs text-amber-400 font-code">{t('app.status.online')}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="chat" className="w-full">
          <TabsList className="grid w-full grid-cols-8 lg:w-[900px] glass-panel p-1 gap-1">
            <TabsTrigger
              value="chat"
            ...
            >
              ...
              <span className="hidden sm:inline">{t('tabs.memory')}</span>
            </TabsTrigger>
            ...
            >
              ...
              <span className="hidden sm:inline">{t('tabs.crontab')}</span>
            </TabsTrigger>
            ...
            >
              ...
              <span className="hidden sm:inline">{t('tabs.terminal')}</span>
            </TabsTrigger>
            <TabsTrigger
              value="settings"
              className="flex items-center gap-2 data-[state=active]:bg-orange-500/20 data-[state=active]:text-orange-400 data-[state=active]:border-orange-500/50 border border-transparent rounded-md transition-all duration-300 font-code text-sm"
          ...
          <div className="mt-6">
            ...
            <TabsContent value="crontab" className="m-0">
              <CrontabTab />
            </TabsContent>
